...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UserAccessFilter) DeepCopyInto(out *UserAccessFilter) {
	*out = *in
	if in.NamespaceFrom != nil {
		in, out := &in.NamespaceFrom, &out.NamespaceFrom
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UserAccessFilter.
func (in *UserAccessFilter) DeepCopy() *UserAccessFilter {
	if in == nil {
		return nil
	}
	out := new(UserAccessFilter)
